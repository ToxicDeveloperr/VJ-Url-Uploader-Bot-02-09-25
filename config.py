...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "7678450283:AAEQ-O-E6CMig5Zl4PQdwDCxMbpFvt30nE8")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "RKDuploderbot") # Bot username without @.
    ...
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://LEGEND_OF_ALL_TIME:4lD7yH5HwL0ONHwq@legend.giyqu.mongodb.net/?retryWrites=true&w=majority&appName=LEGEND")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1001849394394")) # your log channel id and make bot admin in log channel with full right 
    ...
    TECH_VJ_API = environ.get('TECH_VJ_API', '7678450283:AAEQ-O-E6CMig5Zl4PQdwDCxMbpFvt30nE8') # your url shortner api
